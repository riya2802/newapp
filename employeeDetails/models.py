...
class Job(models.Model):
	...
	endofProbation = models.DateField()
	position = models.CharField(max_length=30, null=False)
	jobStatusEffectiveDate = models.DateField(null=False)
	lineManager = models.CharField(max_length=30)
	department = models.CharField(max_length=30)
	branch = models.CharField(max_length=30)
	level = models.CharField(max_length=30)
	jobType = models.CharField(max_length=30)
	employmentStatusEffectiveDate = models.DateField(null=False)
	jobStatus = models.CharField(max_length=30)
	leaveWorkflow = models.CharField(max_length=30)
	workdays = models.CharField(max_length=30)
	holidays= models.CharField(max_length=30)
